      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#interpretacion" aria-expanded="false" aria-controls="flush-collapseOne">
              Interpretación
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#definiciones" aria-expanded="false" aria-controls="flush-collapseOne">
              Definiciones
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#informacion_personal" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#datos_uso" aria-expanded="false" aria-controls="flush-collapseOne">
            Datos de uso
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#uso_personales" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#retencion_datos_personales" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#transferencia_datos_personales" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#eliminar_datos_personales" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#cumplimiento_ley" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#otros_requisitos_legales" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#seguridad" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#enlaces_otras_webs" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#cambios_politica_privacidad" aria-expanded="false" aria-controls="flush-collapseOne">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#contacto" aria-expanded="false" aria-controls="flush-collapseOne">
            Contáctenos
            </button>
          </h2>
